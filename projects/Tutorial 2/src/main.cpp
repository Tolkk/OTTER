...
bool initGLFW() {
	...
	window = glfwCreateWindow(800, 800, "TreytonCowell-100745472", nullptr, nullptr);
...
int main() {
	...
	static const float interleaved[] = {
		// X     Y     Z     R     G     B
		 ...
		 0.5f, 0.3f, 0.5f, 1.0f, 1.0f, 0.0f,
		 0.0f, 0.3f, 0.5f, 1.0f, 1.0f, 1.0f,
	...
	shader1->LoadShaderPartFromFile("shaders/vertex_shader1.glsl", GL_VERTEX_SHADER);
	shader1->LoadShaderPartFromFile("shaders/frag_shader1.glsl", GL_FRAGMENT_SHADER);
	shader1->Link();
