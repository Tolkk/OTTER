...
#define STB_IMAGE_IMPLEMENTION //07
#include <stb_image.h>
...
void loadImage() //pass filepath string as an argument
{
	int channels;
	stbi_set_flip_vertically_on_load(true);

	image = stbi_load("boxChecker.jpg", &width, &height, &channels, 0);
...
bool initGLFW() {
	...
	window = glfwCreateWindow(1000, 800, "Treyton Cowell 100745472", nullptr, nullptr);
...
int main() {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		Model = glm::translate(Model, glm::vec3(0.0f, 0.0f, rotZ));
