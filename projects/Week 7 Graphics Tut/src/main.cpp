...
bool initGLFW() {
	...
	window = glfwCreateWindow(800, 800, "Treyton Cowell - 100745472", nullptr, nullptr);
...
int main() {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		shader->SetUniform("s_Diffuse1", 2);
