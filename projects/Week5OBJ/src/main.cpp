//Treyton Cowell 100745472 OBJ LOADER
...
bool initGLFW() {
	...
	window = glfwCreateWindow(800, 800, "Treyton Cowell 100745472 Week 5 OBJ", nullptr, nullptr);
...
int main() {
	...
	*/
	...
	VertexArrayObject::sptr vao4 = ObjLoader::LoadFile("donut.obj");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		if (glfwGetKey(window, GLFW_KEY_D) == GLFW_PRESS) {
			transform3 = glm::translate(transform3, glm::vec3( 1.0f * dt, 0.0f, 0.0f));//    swapped A and D because it was inverted
		}
		if (glfwGetKey(window, GLFW_KEY_A) == GLFW_PRESS) {
			transform3 = glm::translate(transform3, glm::vec3(-1.0f * dt, 0.0f, 0.0f));//    swapped A and D because it was inverted
		}
		if (glfwGetKey(window, GLFW_KEY_S) == GLFW_PRESS) {
			transform3 = glm::translate(transform3, glm::vec3(0.0f, -1.0f * dt, 0.0f));//    swapped W and S because it was inverted
		}
		...
		transform1 = glm::rotate(glm::mat4(1.0f), static_cast<float>(thisFrame), glm::vec3(0, 0, 1));
		transform2 = transform * (glm::translate(glm::mat4(1.0f), glm::vec3(2, 0.0f, 0.0f)));
		...
		//shader->SetUniformMatrix("u_View", camera->GetView());//    was commented out
